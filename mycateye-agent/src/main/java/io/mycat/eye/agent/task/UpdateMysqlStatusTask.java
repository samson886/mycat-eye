...
import io.mycat.eye.agent.bean.MysqlStatusHistoryExample.Criteria;
...
public class UpdateMysqlStatusTask extends AbstractTask {
	...
	public void execute() {
		...
		for (MysqlServer mysqlServer : mysqlServers) {
			...
			//获取最新状态记录的ID
			Criteria criteria = mysqlStatusHistoryExample.createCriteria();
			criteria.andServerIdEqualTo(serverId);
			mysqlStatusHistoryExample.setOrderByClause("id desc");
			mysqlStatusHistoryExample.setLimitStart(0);
			mysqlStatusHistoryExample.setPageSize(1);

			Long lastId = 0L;
			List<MysqlStatusHistory> lastMysqlStatusHistorys = mysqlStatusHistoryMapper
					.selectByExample(mysqlStatusHistoryExample);
			if (!lastMysqlStatusHistorys.isEmpty()) {
				lastId = lastMysqlStatusHistorys.get(0).getId();
			}
	 ...
	 */
	private String getQuestionsPersecond(MysqlStatusHistory currentStatusHistory,
	 ...
	 * currentStatusHistory @param lastStatusHistory @return @throws
	 */
	private String getBytesSentPersecond(MysqlStatusHistory currentStatusHistory,
			MysqlStatusHistory lastStatusHistory) {
		Date currentCreateTime = currentStatusHistory.getCreateTime();
		Date lastCreateTime = lastStatusHistory.getCreateTime();
	 ...
	 * currentStatusHistory @param lastStatusHistory @return @throws
	 */
	private String getComSelectPersecond(MysqlStatusHistory currentStatusHistory,
			MysqlStatusHistory lastStatusHistory) {
		Date currentCreateTime = currentStatusHistory.getCreateTime();
		Date lastCreateTime = lastStatusHistory.getCreateTime();
	 ...
	 * currentStatusHistory @param lastStatusHistory @return @throws
	 */
	private String getComInsertPersecond(MysqlStatusHistory currentStatusHistory,
			MysqlStatusHistory lastStatusHistory) {
		Date currentCreateTime = currentStatusHistory.getCreateTime();
		Date lastCreateTime = lastStatusHistory.getCreateTime();
	 ...
	 * currentStatusHistory @param lastStatusHistory @return @throws
	 */
	private String getComUpdatePersecond(MysqlStatusHistory currentStatusHistory,
			MysqlStatusHistory lastStatusHistory) {
		Date currentCreateTime = currentStatusHistory.getCreateTime();
		Date lastCreateTime = lastStatusHistory.getCreateTime();
	 ...
	 * currentStatusHistory @param lastStatusHistory @return @throws
	 */
	private String getComDeletePersecond(MysqlStatusHistory currentStatusHistory,
			MysqlStatusHistory lastStatusHistory) {
		Date currentCreateTime = currentStatusHistory.getCreateTime();
		Date lastCreateTime = lastStatusHistory.getCreateTime();
	 ...
	 * currentStatusHistory @param lastStatusHistory @return @throws
	 */
	private String getComCommitPersecond(MysqlStatusHistory currentStatusHistory,
			MysqlStatusHistory lastStatusHistory) {
		Date currentCreateTime = currentStatusHistory.getCreateTime();
		Date lastCreateTime = lastStatusHistory.getCreateTime();
