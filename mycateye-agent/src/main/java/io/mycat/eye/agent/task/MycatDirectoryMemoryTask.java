 ...
 */
@Component
public class MycatDirectoryMemoryTask extends AbstractTask{
    Logger logger = LoggerFactory.getLogger(MycatDirectoryMemoryTask.class);
    private final String SHOW_SQL = "show @@directmemory=1";
